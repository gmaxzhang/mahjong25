# algorithm/mahjongrl/train.py (stateful checkpoints + resume + eval, hybrid CPU envs + GPU model)
...
if __name__ == "__main__":
    ...
    # Number of CPU env workers (0 = no parallelism). Default 8 for 8-way rollout.
